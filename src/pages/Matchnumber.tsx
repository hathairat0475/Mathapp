              ...
              <div className="wrap">
                <div className="bg-quiz">
                  <img
                    ...
                    onClick={() => selectChoice(data[page].choice[0].answer)}
                    id="5"
                    src={data[page].choice[0].title}
                    alt=""
                  />
                </div>
                <div className="bg-quiz">
                  <img
                    className="img-answer"
                    onClick={() => selectChoice(data[page].choice[1].answer)}
                    id="3"
                    src={data[page].choice[1].title}
                    alt=""
                  />
                </div>
                <div className="bg-quiz">
                  <img
                    className="img-answer"
                    onClick={() => selectChoice(data[page].choice[2].answer)}
                    id="2"
                    src={data[page].choice[2].title}
                    alt=""
                  />
                </div>
              </div>
